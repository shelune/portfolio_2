...
(function () {
    var typedWords =  $('.typed-words'),
        typedWordsDesc = $('.typed-words--description');
    ...
    function initHeader() {
        ...
        landingPage.css("height", height + 'px');
        
        canvas = document.getElementById('canvas--animated');
        canvas.width = width;
        ...
        for (var i = 0; i < points.length; i += 1) {
            ...
            for (var j = 0; j < points.length; j += 1) {
                ...
                if (!(p1 == p2)) {
                    var placed = false;
                    for (var k = 0; k < nearestPointsCount; k += 1) {
                        if (!placed) {
    ...
    function drawLines(p) {
        ...
        for (var i in p.closest) {
            ...
            ctx.strokeStyle = 'rgba(184, 240, 225,' + p.active + ')';
            ctx.stroke();
        }
    }
    ...
    function Circle(pos, rad, color) {
        ...
        this.draw = function() {
            ...
            ctx.fillStyle = 'rgba(184, 240, 225,' + _this.active + ')';
            ctx.fill();
        };
    }
